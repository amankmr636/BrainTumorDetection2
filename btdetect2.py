...
class BTdetect2:
       def __init__(self,root):
           ...
           "PatientID", "Date", "Age", "Tumor"),yscrollcommand=ScrollY)
           ...
           self.rtable.heading("Age", text="Age")
           ...
           self.rtable.column("Age", width=100)
       ...
       def save(self):
           ...
           mycursor.execute("insert into tumordetection(ReportID,PatientID,Date,Age,Tumor) values(%s,%s,%s,%s,%s)", (self.var01.get(),
                                                                                                                     self.var02.get(),
                                                                                                            self.var03.get(),
                                                                                                                     self.var04.get(),
                                                                                                                     self.var05.get(),))
